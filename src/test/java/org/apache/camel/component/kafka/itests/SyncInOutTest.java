...
public class SyncInOutTest extends KafkaTestSupport {
    ...
    @Test
    public void syncInOut() throws Exception {
        ...
        template.send("direct:biooutt", ExchangePattern.InOut, new Processor() {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("direct:biooutt").to("kafka:fooiout?zkConnect=localhost:2181&metadataBrokerList=localhost:9092&groupId="+ uid + KafkaConstants.DEFAULT_GROUP.value);
