...
public class AsyncTransferExchangeInOutTest extends KafkaTestSupport {
    ...
    @Test
    public void asyncTransferExchangeInOutTest() throws Exception {
        ...
        template.send("direct:ateioutep", ExchangePattern.InOut, new Processor() {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("direct:ateioutep").to("kafka:ateiout?zkConnect=localhost:2181&metadataBrokerList=localhost:9092&transferExchange=true&producerType=async&groupId="+ uid + KafkaConstants.DEFAULT_GROUP.value);
                from("kafka:ateiout?zkConnect=localhost:2181&transferExchange=true&groupId="+ uid + KafkaConstants.DEFAULT_GROUP.value).to("mock:result");
            }
        };
    }
}
