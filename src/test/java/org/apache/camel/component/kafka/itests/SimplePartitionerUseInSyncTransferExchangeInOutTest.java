...
public class SimplePartitionerUseInSyncTransferExchangeInOutTest extends KafkaTestSupport {
    ...
    @Test
    public void simplePartitionerUseInSyncTransferExchangeInOutTest() throws Exception {
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("direct:bioouttps").to("kafka:fooioutps?zkConnect=localhost:2181&transferExchange=true&partitionerClass=org.apache.camel.component.kafka.partitioner.SimplePartitioner&metadataBrokerList=localhost:9092&groupId="+ uid + KafkaConstants.DEFAULT_GROUP.value);
                from("kafka:fooioutps?zkConnect=localhost:2181&transferExchange=true&groupId="+ uid + KafkaConstants.DEFAULT_GROUP.value).to("mock:result");
            }
        };
    }
}
